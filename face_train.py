...
# with this snippet from face_train.py:
...
class Model:
    ...
    def train(self, dataset, batch_size = 20, nb_epoch = 10, data_augmentation = True):        
        sgd = tf.keras.optimizers.legacy.SGD(lr = 0.01, decay = 1e-6, 
...
if __name__ == '__main__':
    ...
    model.build_model(dataset)
    model.train(dataset)
    model.save_model(file_path = './model/cy.face.model.h5')
...
if __name__ == '__main__':    
    ...
    #评估模型
    model = Model()
    model.load_model(file_path = './model/cy.face.model.h5')
